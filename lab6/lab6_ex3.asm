...
;No return value, no outpuut, but r1 still contains the array address, unchanged
;==================================================================
.orig x3600
...
DO_LOOP_3600
	LDR R0, R1, #0		;GET VAL R1 IN R0
	AND R2, R3, R0
	STR R2, R1, #0		;STORE IN ARRAY
	ADD R1, R1, #1		;INCREASE R1 LOCATION
	ADD R5, R5, #-1
	BRp DO_LOOP_3600
END_DO_LOOP_3600
